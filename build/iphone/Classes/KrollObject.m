...
//@interface FindATDN2Object : NSObject
//@end

@interface FindATDN2Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[FindATDN2Object class]])
		{
			for (NSString *key in [[(FindATDN2Object*)o modules] allKeys])
			{
