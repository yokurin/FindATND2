...
@interface FindATDN2Object : KrollCoverageObject {
#else
@interface FindATDN2Object : KrollObject {
#endif
@private
...
extern NSString * FindATDN2$ModuleRequireFormat;
