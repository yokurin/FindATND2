...
/**
 Base class for all FindATDN2 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the FindATDN2 view hierarchy (such as wrapped iOS UIViews) was touched.
