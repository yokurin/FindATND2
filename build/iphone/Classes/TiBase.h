...
// in simulator we redefine to format for FindATDN2 Developer console
...
{\
	NSString * exceptionName = [@"org.findatdn2." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.findatdn2";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIFindATDN2NativeItemNone = -1, 
	UIFindATDN2NativeItemSpinner = -2,
	UIFindATDN2NativeItemProgressBar = -3,
	
	UIFindATDN2NativeItemSlider = -4,
	UIFindATDN2NativeItemSwitch = -5,
	UIFindATDN2NativeItemMultiButton = -6,
	UIFindATDN2NativeItemSegmented = -7,
	
	UIFindATDN2NativeItemTextView = -8,
	UIFindATDN2NativeItemTextField = -9,
	UIFindATDN2NativeItemSearchBar = -10,
	
	UIFindATDN2NativeItemPicker = -11,
	UIFindATDN2NativeItemDatePicker = -12,
	
	UIFindATDN2NativeItemInfoLight = -13,
	UIFindATDN2NativeItemInfoDark = -14,
	
	UIFindATDN2NativeItemDisclosure = -15,
	
	UIFindATDN2NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all FindATDN2 instances of
